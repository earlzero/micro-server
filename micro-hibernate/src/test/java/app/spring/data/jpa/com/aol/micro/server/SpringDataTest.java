...
public class SpringDataTest {
	...
	public void runAppAndBasicTest() throws InterruptedException, ExecutionException{
		...
		assertThat(rest.get("http://localhost:10080/hibernate-app/persistence/create"),is("ok"));
//works standalone, interferes with other tests		assertThat(listClient.get("http://localhost:10080/hibernate-app/persistence/get").get().get(0),is(SpringDataEntity.class));
